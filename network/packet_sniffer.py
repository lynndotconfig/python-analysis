...
def main():
	...
	parser.add_argument('--iface', action="strore", dest="iface", default='eth0')
	...
	try:
		...
		print 'Packet statistics: %d packets received, %d packets droped, %d packets droppend by the interface' % pc.stats()
